...
@Component({
  ...
  template: `
    ...
    <div class="login-methods">
      <a [routerLink]="['/account/email/login']">
        <button type="button" mat-stroked-button><mat-icon>mail</mat-icon> <span>with Email</span></button>
      </a>
      <a [routerLink]="['/account/github/login']" matTooltip="Not available yet">
      ...
      <a [routerLink]="['/account/google/login']" matTooltip="Not available yet">
        <button type="button" mat-stroked-button disabled>
